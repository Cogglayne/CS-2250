...
constexpr auto testNameSize = 65;

void TestTree(string test, string nodes[], int nbrNodes, string output[], int& nbrFailed, bool isAVL = false)
{
...
void TestTemplatedTree(string test, int size, int& nbrFailed, bool isAVL = false)
{
...
void RunTests(int& nbrFailed)
{
	...
	// Test normal trees
	TestTree("smallRootOnlyTree", smallRootOnlyTree, 1, smallRootOnlyTreeOutput, nbrFailed);
	TestTree("smallSimpleTree", smallSimpleTree, 3, smallSimpleTreeOutput, nbrFailed);
	TestTree("smallFullTree", smallFullTree, 7, smallFullTreeOutput, nbrFailed);

	TestTree("rightLeftTree", rightLeftTree, 3, rightLeftTreeOutput, nbrFailed);
	TestTree("leftRightTree", leftRightTree, 3, leftRightTreeOutput, nbrFailed);
	TestTree("rightRightTree", rightRightTree, 3, rightRightTreeOutput, nbrFailed);
	TestTree("leftLeftTree", leftLeftTree, 3, leftLeftTreeOutput, nbrFailed);
	TestTree("largeTree", largeTree, 25, largeTreeOutput, nbrFailed);

	////////////////////////////////////////////////////////////////////////////////
	// AVL Tests
	// Uncomment this portion of the file to test your AVL BinaryTree
	////////////////////////////////////////////////////////////////////////////////

	// TODO: Once you've added AVL balancing in week 2, uncomment this code

	//// Test the AVL tree
	//TestTree("rightLeftTreeAVL", rightLeftTree, 3, rightLeftTreeOutputAVL, nbrFailed, true);
	//TestTree("leftRightTreeAVL", leftRightTree, 3, leftRightTreeOutputAVL, nbrFailed, true);
	//TestTree("rightRightTreeAVL", rightRightTree, 3, rightRightTreeOutputAVL, nbrFailed, true);
	//TestTree("leftLeftTreeAVL", leftLeftTree, 3, leftLeftTreeOutputAVL, nbrFailed, true);
	//TestTree("largeTreeAVL", largeTree, 25, largeTreeOutputAVL, nbrFailed, true);
	//TestTree("largeTreeAVL", largeTree, 25, largeTreeOutputAVL, nbrFailed, true);
	...
	//TestTemplatedTree("FiveIntegerTemplateTree", 5, nbrFailed);
	//TestTemplatedTree("FifteenIntegerTemplateTree", 15, nbrFailed);
	//TestTemplatedTree("TwentyFiveIntegerTemplateTree", 25, nbrFailed);
	//TestTemplatedTree("FiftyIntegerTemplateTree", 50, nbrFailed);
